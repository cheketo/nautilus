...
class Nautilus {
    ...
    /**
     * @var $API_ROOT_URL is a main URL to access the Nautilus API's.
     */
		protected static $API_ROOT_URL = "http://api.nautilus.com.ar";
    /**
     * Configuration for CURL
     */
    public static $CURL_OPTS = array(
        CURLOPT_USERAGENT => "NAUTILUS-PHP-SDK-1.0.0",
