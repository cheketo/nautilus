<?php
	...
	/* MELI REDIRECT URL */
	$MeliURL = 'https://nautilus-cheketo.c9users.io/files/modules/test/process.meli.landing.php';
	/* MELI NOTIFICATIONS URL */
	$MeliNotificationsURL = 'https://nautilus-cheketo.c9users.io/files/modules/test/process.meli.notifications.php';
